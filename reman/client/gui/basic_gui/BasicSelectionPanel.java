...
public class BasicSelectionPanel<E> extends JPanel {
   ...
   *          options list.
   */
  public BasicSelectionPanel(String title, Collection<E> options,
      Collection<E> selected, int w, int h, final boolean replication) {
    if (options == null) {
    ...
    options_view_.setPreferredSize(new Dimension((int) (.4 * w), h
	- bottom_margin_));
    options_view_
	.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
    options_view_
	.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
    layout_.putConstraint(SpringLayout.NORTH, options_view_, 0,
	SpringLayout.NORTH, this);
    layout_.putConstraint(SpringLayout.WEST, options_view_, side_margin_,
    ...
    selected_view_.setPreferredSize(new Dimension((int) (.4 * w), h
	- bottom_margin_));
    selected_view_
	.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
    selected_view_
	.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
    layout_.putConstraint(SpringLayout.NORTH, selected_view_, 0,
	SpringLayout.NORTH, this);
    layout_.putConstraint(SpringLayout.EAST, selected_view_, -side_margin_,
    ...
    layout_.putConstraint(SpringLayout.SOUTH, add_,
	((h - bottom_margin_) / 2) - 5, SpringLayout.NORTH, this);
    layout_.putConstraint(SpringLayout.WEST, add_, (w - (2 * side_margin_)) / 2
	- add_.getPreferredSize().width / 2, SpringLayout.WEST, this);
    this.add(add_);
    ...
    layout_.putConstraint(SpringLayout.NORTH, remove_,
	((h - bottom_margin_) / 2) + 5, SpringLayout.NORTH, this);
    layout_.putConstraint(SpringLayout.WEST, remove_, (w - (2 * side_margin_))
	/ 2 - remove_.getPreferredSize().width / 2, SpringLayout.WEST, this);
    this.add(remove_);
  }
