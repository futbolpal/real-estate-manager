...
public abstract class BasicDialog extends JDialog {
   ...
   *            Instructions for dialog
   */
  public BasicDialog(String title, int w, int h, String instructions, Image icon) {
  ...
  protected void addButton(JComponent button, float alignment,
	...
	layout.putConstraint(SpringLayout.EAST, button, -5, SpringLayout.WEST,
	    last_added);
      } else {
	...
	layout.putConstraint(SpringLayout.WEST, button, 5, SpringLayout.EAST,
	    last_added);
      } else {
