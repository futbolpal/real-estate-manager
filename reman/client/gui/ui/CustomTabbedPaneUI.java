...
import reman.client.gui.basic_gui.BasicTabbedPane;
...
public class CustomTabbedPaneUI extends WindowsTabbedPaneUI {
  ...
  public Rectangle getTabBounds(JTabbedPane p, int i) {
    ...
    r.height = this.calculateTabHeight(p.getTabPlacement(), i, this
	.getFontMetrics().getHeight());
    r.width = this.calculateTabWidth(p.getTabPlacement(), i, this
	.getFontMetrics());
    return r;
  }
  ...
  protected void paintFocusIndicator(Graphics g, int p, Rectangle[] rects,
      int i, Rectangle iconRect, Rectangle textRect, boolean s) {
  }
