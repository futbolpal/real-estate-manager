...
public class Framework {
	public static boolean MESSAGING_OFF = true;
	...
	private UserDatabaseObject first_run_;
	...
	private void start() throws SQLException {
		if (Framework.DEBUG) {
			try {
				boolean f = UserManager.instance().login("Futbolpal", "Jonathan");
				if (!f) {
					UserManager.instance().register("Futbolpal", "Jonathan", "Jonathan Lewis", "test", true);
